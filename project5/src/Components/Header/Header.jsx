...
export default function Header() {
    return (
        <header className=" sticky z-50  mb-12 sm:mb-16 top-0">
            <nav className=" bg-slate-500  shadow-lg shadow-gray-50/45 hover:shadow-gray-50/80   rounded-2xl border-zinc-50 px-4 lg:px-6 py-2.5">
