...
export default function About() {
  return (
   ...
   <div className='md:grid  gap-20 md:grid-cols-2 '> 
       <img className=' rounded-full p-auto mr-0 mt-auto mb-auto ml-auto  m-auto grid grid-rows-2 shadow-2xl  shadow-black  border-white border-4'
        src="./me.jpg" alt="prof picture" width={300} />
        <div className='mr-auto mt-auto mb-auto ml-0 '>
        <h1 className='text-8xl  text-left text-gray-800 font-semibold font-mono mb-4'> Sakshi</h1>
        <h1 className="text-6xl  text-right text-gray-800 font-semibold font-oswald mb-4"> 🎯Kolekar!!</h1>
        </div>
   </div>
